...
export class InitialMigration1589133350757 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "user_model" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(),"name" character varying(500) NOT NULL, "password" character varying(500) NOT NULL, "email" character varying(500) NOT NULL, "role" character varying(200) NOT NULL,`, undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE "user_model"`, undefined);
